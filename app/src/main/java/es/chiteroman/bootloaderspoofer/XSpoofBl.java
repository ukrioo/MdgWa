...
//        XposedBridge.log("[-] Creating hacked extensions");
...
//        XposedBridge.log("[-] Creating leaf certificate");
...
//            XposedBridge.log(t);
    ...
    public static void doHook(XC_LoadPackage.LoadPackageParam param) {
...
//                XposedBridge.log("[-] System feature: " + featureName);
        ...
        try {
            ...
            if (app == null) {
                PackageManagerClass = XposedHelpers.findClass("android.app.ApplicationPackageManager", param.classLoader);
                SharedPreferencesClass = XposedHelpers.findClass("android.app.SharedPreferencesImpl", param.classLoader);
...
//                    XposedBridge.log("[-] AttestKey: " + key);
...
//                    XposedBridge.log("[-] Getting certificates");
